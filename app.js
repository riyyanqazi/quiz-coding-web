...
options.forEach((e, val) => {
  options[val].addEventListener("click", (e) => {
    ...
    e.currentTarget.style.border = "1px solid #ffb300";
    let useroption = options[val].innerText;
    userAnser.push(useroption);
...
next_btn.addEventListener("click", (e) => {
  ...
  question_count.innerText = questionsCount + 1;
  question.innerText = htmlQuiz[questionsCount].question;

  options.forEach((opt, val) => {
    opt.innerText = htmlQuiz[questionsCount].options[val];
